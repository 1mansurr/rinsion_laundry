    ...
    <div className="min-[720px]:hidden flex-shrink-0 h-[54px] flex items-center gap-3 px-[18px] bg-white border-b border-warm-300">
      ...
      <div className="ml-auto flex items-center gap-2">
        <Link
          ...
          className="w-11 h-11 rounded-10 bg-warm-150 border border-warm-300 flex items-center justify-center"
        >
        ...
        <span aria-hidden className="w-11 h-11 rounded-10 bg-warm-150 border border-warm-300 flex items-center justify-center">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="#6B6259" aria-hidden>

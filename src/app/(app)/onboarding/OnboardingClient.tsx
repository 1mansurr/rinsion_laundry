...
export function OnboardingClient({ laundryId, defaultLaundryName, defaultBranchId, defaultBranchName }: Props) {
  ...
  async function saveStep2() {
    ...
    setError('')
    startTransition(async () => {
      // Create default items and selected services
  ...
  async function saveStep3() {
    setError('')
    startTransition(async () => {
      // Save any prices entered in the grid
        ...
        <div className="w-full max-w-[680px]">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <Button onClick={saveStep2} isPending={isPending} size="lg">Next</Button>
                </div>
              </div>
            </div>
          )}
          ...
          {step === 3 && (
            <div className="space-y-6">
              ...
              {createdServiceIds.length > 0 && createdItemIds.length > 0 ? (
                <div className="bg-white border border-warm-300 rounded-10 overflow-hidden">
                  {/* Header */}
                  <div
                ...
                <div className="bg-white border border-warm-300 rounded-10 p-5 text-center">
                  <p className="text-body text-warm-500">
                    No services were created in step 2. You can set pricing from Settings → Items &amp; Services.
                  </p>
                </div>
              )}
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <Button onClick={saveStep3} isPending={isPending} size="lg">Finish</Button>
                </div>
              </div>
            </div>
          )}

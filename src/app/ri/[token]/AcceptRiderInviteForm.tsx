...
import { acceptRiderInvite } from './actions'
import { Wordmark } from '@/components/ui/Wordmark'
import { PasswordInput } from '@/components/ui/PasswordInput'

const initialState = { error: null }

export function AcceptRiderInviteForm({ token }: { token: string }) {
  const [state, action] = useFormState(acceptRiderInvite, initialState)
    ...
    <main className="min-h-screen flex items-center justify-center bg-canvas px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-body text-warm-600">Set up your rider account</p>
        </div>

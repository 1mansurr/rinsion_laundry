...
* 14 days of Starter-level access (1 Admin, up to 4 Employees, 1 Branch, 350 SMS per cycle) — the trial mirrors Starter rather than Growth, so moving to a paid plan afterward is a lateral move, not a downgrade

...
- **Rinsion / the Service:** the Rinsion laundry management platform.
- **Laundry:** the business that holds a Rinsion account.
- **Account Holder:** an administrator or employee the Laundry authorises to use the Service.
- **End Customer:** a customer of the Laundry whose details the Laundry records in the Service.
- **Customer Data:** personal data about End Customers that the Laundry stores in the Service.

## 3. The Service

Rinsion helps a Laundry manage orders, customers, pricing, payments (recording), staff activity, and SMS notifications. We may add, change, or remove features over time. Rinsion is an early-stage product and is provided on an evolving basis.
...
New Laundries may receive a one-time free trial of **14 days**. During the trial the Service operates normally, within the trial's account and message allowances (see Section 6). At the end of the trial, continued use requires a paid subscription. We may change or withdraw trial terms for future sign-ups.
...
This section governs personal data about End Customers.
...
- Attempt to access another Laundry's data or otherwise breach the system's security
...
We own the Rinsion platform, software, and brand. You own your business data and Customer Data. You grant us the limited right to host and process that data solely to provide the Service, and for no other purpose.

## 12. Availability

The Service is provided on an "as available" basis. As an early-stage product, we do not currently promise a specific uptime level, and we may occasionally suspend the Service for maintenance, updates, or fixes. We will try to limit disruption and to give notice of planned downtime where we reasonably can. Nothing in this section removes any right you have under Ghanaian law that cannot be excluded.
...
You agree to cover us for claims arising from your misuse of the Service or your unlawful collection or use of Customer Data, including messaging recipients without a lawful basis. This does not apply to the extent a claim results from our own breach of these Terms or our own negligence.
...
We may update these Terms as the Service evolves. If we make a significant change, we will update the "Last updated" date and, where appropriate, notify Account Holders. Continued use after a change means you accept the updated Terms.
